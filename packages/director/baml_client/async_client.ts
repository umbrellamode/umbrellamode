...
import type {Joke, Resume} from "./types"
    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        __baml_options__?: BamlCallOptions
          ...
          // Check if onTick is provided - route through streaming if so
          if (options.onTick) {
          const stream = this.stream.TellJoke(
          input,
          __baml_options__
          );
          ...
          const env: Record<string, string> = Object.fromEntries(
            ...
            return raw.parsed(false) as types.Joke
            } catch (error) {
            throw toBamlError(error);
            }
            }
            ...
            input: string,
            __baml_options__?: BamlCallOptions
            ): BamlStream<partial_types.Joke, types.Joke>
              {
              try {
              const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const signal = options.signal;
              ...
              console.error("Error in onTick callback for TellJoke", error);
              }
              }
              };
              }
              ...
              const env: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.Joke, types.Joke>(
                  raw,
                  (a): partial_types.Joke => a,
                  (a): types.Joke => a,
                  this.ctxManager.cloneContext(),
                  options.signal,
                  )
